...
const Contact = ({ isOpen, onToggle }) => {
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: connect with EmailJS / backend later
  };
          ...
          <div className="p-6 max-h-[70vh] overflow-y-auto">
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-dark-800 dark:text-gray-200"
              />
