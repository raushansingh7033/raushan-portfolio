...
const Hero = () => {
  ...
  // Particle settings
  const particleColor = darkMode ? "#3B82F6" : "#1D4ED8";
  const linkColor = darkMode ? "#93C5FD" : "#1E40FF";
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <div className="flex justify-center gap-6">
            <a
              href="https://github.com/raushansingh7033"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/in/raushansingh7033"
              target="_blank"
              rel="noopener noreferrer"
            >
